        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Empowering your financial journey with data-driven insights and personalized recommendations.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link href="/advisor" className="hover:text-white">AI Financial Advisor</Link>
              </li>
              <li>
                <Link href="/tax" className="hover:text-white">Tax Calculator</Link>
              </li>
              <li>
                <Link href="/investments" className="hover:text-white">Investment Advisor</Link>
              </li>
              <li>
                <Link href="/insurance" className="hover:text-white">Insurance Planning</Link>
              </li>
              <li>
                <Link href="/budget" className="hover:text-white">Budget Management</Link>
              </li>
            </ul>
          </div>
