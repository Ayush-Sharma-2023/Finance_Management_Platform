...
const generateInvestmentGrowthData = (
...
export default function InvestmentAdvisor() {
  ...
  const investmentGrowthData = generateInvestmentGrowthData(
    remainingBudget,
    months
  );
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="mt-2 text-gray-700">
                    ...
                    {remainingBudget.toLocaleString()}, we recommend a{" "}
          ...
          <div className="grid gap-6 md:grid-cols-2 mt-8">
            ...
            <Card className="p-6 bg-white shadow-md rounded-lg">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    data={Object.entries(allocation).map(([key, value]) => ({
                      name: key,
                      value,
                    }))}
                    dataKey="value"
